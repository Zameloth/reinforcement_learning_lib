...
fn main() {
    unsafe {
        ...
        let secret_env_0_transition_probability: libloading::Symbol<unsafe extern "C" fn(usize, usize, usize, usize) -> f32> =
        ...
        let secret_env_0_state_id: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            lib.get(b"secret_env_0_state_id").expect("Failed to load function `secret_env_0_state_id`");
        dbg!(secret_env_0_state_id(env));

        let secret_env_0_is_forbidden: libloading::Symbol<unsafe extern "C" fn(*const c_void, usize) -> bool> =
        ...
        let secret_env_0_is_game_over: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> bool> =
        ...
        while !secret_env_0_is_game_over(env) {
            let secret_env_0_display: libloading::Symbol<unsafe extern "C" fn(*const c_void)> =
                lib.get(b"secret_env_0_display").expect("Failed to load function `secret_env_0_display`");
            dbg!(secret_env_0_display(env));
            
            let secret_env_0_available_actions: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> *const usize> =
            ...
            let secret_env_0_available_actions_len: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            ...
            let secret_env_0_available_actions_delete: libloading::Symbol<unsafe extern "C" fn(*const usize, usize)> =
        ...
        let secret_env_0_delete: libloading::Symbol<unsafe extern "C" fn(*mut c_void)> =
            lib.get(b"secret_env_0_delete").expect("Failed to load function `secret_env_0_delete`");
        secret_env_0_delete(env);


        let secret_env_0_from_random_state: libloading::Symbol<unsafe extern "C" fn() -> *mut c_void> =
        ...
        let secret_env_1_transition_probability: libloading::Symbol<unsafe extern "C" fn(usize, usize, usize, usize) -> f32> =
        ...
        let secret_env_1_state_id: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            lib.get(b"secret_env_1_state_id").expect("Failed to load function `secret_env_1_state_id`");
        dbg!(secret_env_1_state_id(env));

        let secret_env_1_is_forbidden: libloading::Symbol<unsafe extern "C" fn(*const c_void, usize) -> bool> =
        ...
        let secret_env_1_is_game_over: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> bool> =
        ...
        while !secret_env_1_is_game_over(env) {
            let secret_env_1_display: libloading::Symbol<unsafe extern "C" fn(*const c_void)> =
                lib.get(b"secret_env_1_display").expect("Failed to load function `secret_env_1_display`");
            dbg!(secret_env_1_display(env));
            
            let secret_env_1_available_actions: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> *const usize> =
            ...
            let secret_env_1_available_actions_len: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            ...
            let secret_env_1_available_actions_delete: libloading::Symbol<unsafe extern "C" fn(*const usize, usize)> =
        ...
        let secret_env_1_delete: libloading::Symbol<unsafe extern "C" fn(*mut c_void)> =
            lib.get(b"secret_env_1_delete").expect("Failed to load function `secret_env_1_delete`");
        secret_env_1_delete(env);

        let secret_env_1_from_random_state: libloading::Symbol<unsafe extern "C" fn() -> *mut c_void> =
        ...
        let secret_env_2_transition_probability: libloading::Symbol<unsafe extern "C" fn(usize, usize, usize, usize) -> f32> =
        ...
        let secret_env_2_state_id: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            lib.get(b"secret_env_2_state_id").expect("Failed to load function `secret_env_2_state_id`");
        dbg!(secret_env_2_state_id(env));

        let secret_env_2_is_forbidden: libloading::Symbol<unsafe extern "C" fn(*const c_void, usize) -> bool> =
        ...
        let secret_env_2_is_game_over: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> bool> =
        ...
        while !secret_env_2_is_game_over(env) {
            let secret_env_2_display: libloading::Symbol<unsafe extern "C" fn(*const c_void)> =
                lib.get(b"secret_env_2_display").expect("Failed to load function `secret_env_2_display`");
            dbg!(secret_env_2_display(env));

            let secret_env_2_available_actions: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> *const usize> =
            ...
            let secret_env_2_available_actions_len: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            ...
            let secret_env_2_available_actions_delete: libloading::Symbol<unsafe extern "C" fn(*const usize, usize)> =
        ...
        let secret_env_2_delete: libloading::Symbol<unsafe extern "C" fn(*mut c_void)> =
            lib.get(b"secret_env_2_delete").expect("Failed to load function `secret_env_2_delete`");
        secret_env_2_delete(env);

        let secret_env_2_from_random_state: libloading::Symbol<unsafe extern "C" fn() -> *mut c_void> =
        ...
        let secret_env_3_transition_probability: libloading::Symbol<unsafe extern "C" fn(usize, usize, usize, usize) -> f32> =
        ...
        let secret_env_3_state_id: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            lib.get(b"secret_env_3_state_id").expect("Failed to load function `secret_env_3_state_id`");
        dbg!(secret_env_3_state_id(env));

        let secret_env_3_is_forbidden: libloading::Symbol<unsafe extern "C" fn(*const c_void, usize) -> bool> =
        ...
        let secret_env_3_is_game_over: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> bool> =
        ...
        while !secret_env_3_is_game_over(env) {
            let secret_env_3_display: libloading::Symbol<unsafe extern "C" fn(*const c_void)> =
                lib.get(b"secret_env_3_display").expect("Failed to load function `secret_env_3_display`");
            dbg!(secret_env_3_display(env));

            let secret_env_3_available_actions: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> *const usize> =
            ...
            let secret_env_3_available_actions_len: libloading::Symbol<unsafe extern "C" fn(*const c_void) -> usize> =
            ...
            let secret_env_3_available_actions_delete: libloading::Symbol<unsafe extern "C" fn(*const usize, usize)> =
        ...
        let secret_env_3_delete: libloading::Symbol<unsafe extern "C" fn(*mut c_void)> =
            lib.get(b"secret_env_3_delete").expect("Failed to load function `secret_env_3_delete`");
        secret_env_3_delete(env);

        let secret_env_3_from_random_state: libloading::Symbol<unsafe extern "C" fn() -> *mut c_void> =
